...
import MuiThemeProvaider from 'material-ui/styles/MuiThemeProvider';
    ...
    return(
      <MuiThemeProvaider>
        <div className="container">
          ...
          <div className="row">
            <div className="col xs-12 m7"><Player player={this.state.currentPlayer} showEditForm={this.showEditForm}/></div>
            <div className="col xs-12 m5">
